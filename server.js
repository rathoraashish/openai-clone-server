...
import { generateText } from "./src/apis/davinci.js";
import { generateImage } from "./src/apis/dalle.js";
import { generateVoiceToText } from "./src/apis/whisper.js";
...
app.post("/davinci", validateUser, async (req, res) => {
  ...
  try {
    ...
    const response = await generateText(cleanPrompt, openai, promptWithHistory);
